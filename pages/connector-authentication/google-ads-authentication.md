...
permalink: google-ads-authentication
tags: [connector]
---
...
For example, the **Google Sheets** Connector requires you to enable the Google Sheets API _and_ the Google Drive API. If you only enable the Google Sheets API, Cyclr will be able to work with data within a Spreadsheet, but it won’t have access to list the available Spreadsheets to choose from.
